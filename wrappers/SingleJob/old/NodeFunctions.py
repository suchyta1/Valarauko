...
def CommonBargs(opts, outdir, indexstart, seed, ngal):
...
if __name__ == "__main__":
    opts = GetOpts()
    tnames = opts.tables.strip().split(',')
    ...
    if opts.presex:
        ...
        bargs = CommonBargs(opts, outdir, 0, 0, 0)
    ...
    for i in range(nsim):
        ...
        seed = opts.tileindex*nsim + i
        bargs = CommonBargs(opts, outdir, indexstart, seed, opts.ngal)
