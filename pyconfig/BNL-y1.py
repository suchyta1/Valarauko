...
def CustomParseArgs(args):
    args.ext = 1
    args.catalog = '/astro/u/jelena/Balrog/Catalogs/CMC_originalR_v1.fits'
...
def SLRshift(args):
    slr = suchyta_utils.slr.SLR(release='y1a1', area='wide', slrdir='/gpfs01/astro/workarea/esuchyta/software/SLR', balrogprint=args.syslog)
